...
})({"iTc0O":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "f91607769eaf46ad";
"use strict";
...
},{}],"2XWFZ":[function(require,module,exports) {
...
async function getCountryByName() {
    ...
    try {
        const result = await _axiosDefault.default.get(`https://restcountries.com/v2/name/${userInput}`);
...
function displayCapitalInfo(result) {
    ...
    if (result.data[0].currencies.length > 1) printCapitalInfo.textContent += result.data[0].currencies[0].name + " and with " + result.data[0].currencies[1].name + "'s";
    else printCapitalInfo.textContent += result.data[0].currencies[0].name;
...
function displayLanguages(result) {
    ...
    for(let i = 0; i < numberOfLanguages; i++)if (numberOfLanguages - i > 1) printLanguageInfo.textContent += result.data[0].languages[i].name + " and ";
    else printLanguageInfo.textContent += result.data[0].languages[i].name;
...
},{"axios":"2n2zH","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2n2zH":[function(require,module,exports) {
module.exports = require('./lib/axios');

},{"./lib/axios":"9CSSq"}],"9CSSq":[function(require,module,exports) {
'use strict';
...
},{"./utils":"lN2Yo","./helpers/bind":"dO1Nb","./core/Axios":"bWtdT","./core/mergeConfig":"ddjvr","./defaults":"fDwIo","./cancel/Cancel":"itskO","./cancel/CancelToken":"gLjlY","./cancel/isCancel":"lIQUe","./helpers/spread":"d2d3W","./helpers/isAxiosError":"fWGPW"}],"lN2Yo":[function(require,module,exports) {
'use strict';
var bind = require('./helpers/bind');
...
},{"./helpers/bind":"dO1Nb"}],"dO1Nb":[function(require,module,exports) {
'use strict';
...
},{}],"bWtdT":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo","../helpers/buildURL":"aXhoZ","./InterceptorManager":"3cHDm","./dispatchRequest":"eucnP","./mergeConfig":"ddjvr","../helpers/validator":"kmAIx"}],"aXhoZ":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
function encode(val) {
...
},{"./../utils":"lN2Yo"}],"3cHDm":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo"}],"eucnP":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo","./transformData":"eFGRY","../cancel/isCancel":"lIQUe","../defaults":"fDwIo"}],"eFGRY":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
var defaults = require('./../defaults');
/**
...
},{"./../utils":"lN2Yo","./../defaults":"fDwIo"}],"fDwIo":[function(require,module,exports) {
...
},{"process":"lDnB8","./utils":"lN2Yo","./helpers/normalizeHeaderName":"i3ttQ","./core/enhanceError":"flCBY","./adapters/xhr":"dKBAE","./adapters/http":"dKBAE"}],"lDnB8":[function(require,module,exports) {
...
},{}],"i3ttQ":[function(require,module,exports) {
'use strict';
var utils = require('../utils');
...
},{"../utils":"lN2Yo"}],"flCBY":[function(require,module,exports) {
'use strict';
/**
...
},{}],"dKBAE":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo","./../core/settle":"a1R2h","./../helpers/cookies":"1S0L3","./../helpers/buildURL":"aXhoZ","../core/buildFullPath":"aouGQ","./../helpers/parseHeaders":"hhLoM","./../helpers/isURLSameOrigin":"lQLfU","../core/createError":"kOg25"}],"a1R2h":[function(require,module,exports) {
'use strict';
...
},{"./createError":"kOg25"}],"kOg25":[function(require,module,exports) {
'use strict';
...
},{"./enhanceError":"flCBY"}],"1S0L3":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo"}],"aouGQ":[function(require,module,exports) {
'use strict';
...
},{"../helpers/isAbsoluteURL":"kcP8M","../helpers/combineURLs":"hNaL2"}],"kcP8M":[function(require,module,exports) {
'use strict';
/**
...
},{}],"hNaL2":[function(require,module,exports) {
'use strict';
/**
...
},{}],"hhLoM":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo"}],"lQLfU":[function(require,module,exports) {
'use strict';
var utils = require('./../utils');
...
},{"./../utils":"lN2Yo"}],"lIQUe":[function(require,module,exports) {
'use strict';
module.exports = function isCancel(value) {
    return !!(value && value.__CANCEL__);
};

},{}],"ddjvr":[function(require,module,exports) {
'use strict';
var utils = require('../utils');
/**
...
},{"../utils":"lN2Yo"}],"kmAIx":[function(require,module,exports) {
'use strict';
...
},{"./../../package.json":"4vPlH"}],"4vPlH":[function(require,module,exports) {
module.exports = JSON.parse("{\"_from\":\"axios\",\"_id\":\"axios@0.21.4\",\"_inBundle\":false,\"_integrity\":\"sha512-ut5vewkiu8jjGBdqpM44XxjuCjq9LAKeHVmoVfHVzy8eHgxxq8SbAVQNovDA8mVi05kP0Ea/n/UzcSHcTJQfNg==\",\"_location\":\"/axios\",\"_phantomChildren\":{},\"_requested\":{\"type\":\"tag\",\"registry\":true,\"raw\":\"axios\",\"name\":\"axios\",\"escapedName\":\"axios\",\"rawSpec\":\"\",\"saveSpec\":null,\"fetchSpec\":\"latest\"},\"_requiredBy\":[\"#USER\",\"/\"],\"_resolved\":\"https://registry.npmjs.org/axios/-/axios-0.21.4.tgz\",\"_shasum\":\"c67b90dc0568e5c1cf2b0b858c43ba28e2eda575\",\"_spec\":\"axios\",\"_where\":\"/Users/roykersten\",\"author\":{\"name\":\"Matt Zabriskie\"},\"browser\":{\"./lib/adapters/http.js\":\"./lib/adapters/xhr.js\"},\"bugs\":{\"url\":\"https://github.com/axios/axios/issues\"},\"bundleDependencies\":false,\"bundlesize\":[{\"path\":\"./dist/axios.min.js\",\"threshold\":\"5kB\"}],\"dependencies\":{\"follow-redirects\":\"^1.14.0\"},\"deprecated\":false,\"description\":\"Promise based HTTP client for the browser and node.js\",\"devDependencies\":{\"coveralls\":\"^3.0.0\",\"es6-promise\":\"^4.2.4\",\"grunt\":\"^1.3.0\",\"grunt-banner\":\"^0.6.0\",\"grunt-cli\":\"^1.2.0\",\"grunt-contrib-clean\":\"^1.1.0\",\"grunt-contrib-watch\":\"^1.0.0\",\"grunt-eslint\":\"^23.0.0\",\"grunt-karma\":\"^4.0.0\",\"grunt-mocha-test\":\"^0.13.3\",\"grunt-ts\":\"^6.0.0-beta.19\",\"grunt-webpack\":\"^4.0.2\",\"istanbul-instrumenter-loader\":\"^1.0.0\",\"jasmine-core\":\"^2.4.1\",\"karma\":\"^6.3.2\",\"karma-chrome-launcher\":\"^3.1.0\",\"karma-firefox-launcher\":\"^2.1.0\",\"karma-jasmine\":\"^1.1.1\",\"karma-jasmine-ajax\":\"^0.1.13\",\"karma-safari-launcher\":\"^1.0.0\",\"karma-sauce-launcher\":\"^4.3.6\",\"karma-sinon\":\"^1.0.5\",\"karma-sourcemap-loader\":\"^0.3.8\",\"karma-webpack\":\"^4.0.2\",\"load-grunt-tasks\":\"^3.5.2\",\"minimist\":\"^1.2.0\",\"mocha\":\"^8.2.1\",\"sinon\":\"^4.5.0\",\"terser-webpack-plugin\":\"^4.2.3\",\"typescript\":\"^4.0.5\",\"url-search-params\":\"^0.10.0\",\"webpack\":\"^4.44.2\",\"webpack-dev-server\":\"^3.11.0\"},\"homepage\":\"https://axios-http.com\",\"jsdelivr\":\"dist/axios.min.js\",\"keywords\":[\"xhr\",\"http\",\"ajax\",\"promise\",\"node\"],\"license\":\"MIT\",\"main\":\"index.js\",\"name\":\"axios\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/axios/axios.git\"},\"scripts\":{\"build\":\"NODE_ENV=production grunt build\",\"coveralls\":\"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js\",\"examples\":\"node ./examples/server.js\",\"fix\":\"eslint --fix lib/**/*.js\",\"postversion\":\"git push && git push --tags\",\"preversion\":\"npm test\",\"start\":\"node ./sandbox/server.js\",\"test\":\"grunt test\",\"version\":\"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json\"},\"typings\":\"./index.d.ts\",\"unpkg\":\"dist/axios.min.js\",\"version\":\"0.21.4\"}");

},{}],"itskO":[function(require,module,exports) {
'use strict';
/**
...
},{}],"gLjlY":[function(require,module,exports) {
'use strict';
...
},{"./Cancel":"itskO"}],"d2d3W":[function(require,module,exports) {
'use strict';
/**
...
},{}],"fWGPW":[function(require,module,exports) {
'use strict';
/**
...
},{}]},["iTc0O","2XWFZ"], "2XWFZ", "parcelRequirecb08")

//# sourceMappingURL=country-search.9eaf46ad.js.map
